...
const CHANNELS: Channel[] = [
  ...
  { id: 'shopify', name: 'Shopify', icon: '🛍️', color: 'from-green-500/20 to-green-600/20', status: 'connected', handle: 'auraliftessentials.com', revenue: 12847, orders: 156, syncEnabled: true, apiType: 'oauth' },
  { id: 'tiktok', name: 'TikTok', icon: '🎵', color: 'from-pink-500/20 to-cyan-500/20', status: 'connected', handle: '@ryan.auralift', revenue: 8450, orders: 89, syncEnabled: true, apiType: 'oauth' },
  { id: 'tiktok_shop', name: 'TikTok Shop', icon: '🛒', color: 'from-pink-500/20 to-purple-500/20', status: 'connected', handle: '@ryan.auralift', revenue: 6240, orders: 78, syncEnabled: true, apiType: 'oauth' },
  { id: 'instagram', name: 'Instagram', icon: '📸', color: 'from-purple-500/20 to-pink-500/20', status: 'connected', handle: '@auraliftessentials', revenue: 5670, orders: 67, syncEnabled: true, apiType: 'oauth' },
  ...
  { id: 'pinterest', name: 'Pinterest', icon: '📌', color: 'from-red-500/20 to-rose-500/20', status: 'connected', handle: 'AuraLift Essentials', revenue: 3890, orders: 45, syncEnabled: true, apiType: 'oauth' },
