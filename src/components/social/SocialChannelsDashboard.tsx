...
export function SocialChannelsDashboard() {
  ...
  const platformStats: Record<string, any> = {
    tiktok: { followers: 24500, engagement: 8.4, posts7d: 12, reach: 145000 },
    instagram: { followers: 18200, engagement: 4.2, posts7d: 8, reach: 89000 },
    pinterest: { followers: 12800, engagement: 6.1, posts7d: 24, reach: 210000 },
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold font-mono">
                    {connectedCount}/{SOCIAL_PLATFORMS.length + SALES_PLATFORMS.length}
                  </p>
